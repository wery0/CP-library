...
template<typename T>
T dist_point_line(const pt<T>& p, const pt<T>& p1, const pt<T>& p2) {
    line l = line(p1, p2);
    return abs(l.A * p.x + l.B * p.y + l.C);
}

template<typename T>
T dist_segment_segment(const pt<T>& p1, const pt<T>& p2, const pt<T>& p3, const pt<T>& p4) {
    T dst = min({
...
template<typename T>
T dist_point_ray(const pt<T>& p, const pt<T>& p1, const pt<T>& p2) {
    line l = line(p1, p2);
    pt i = l.get_projection_of_point(p);
...
template<typename T>
T dist_segment_ray(const pt<T>& p1, const pt<T>& p2, const pt<T>& p3, const pt<T>& p4) {
    T dst = min({
...
template<typename T>
T dist_segment_line(const pt<T>& p1, const pt<T>& p2, const pt<T>& p3, const pt<T>& p4) {
    return min(dist_segment_ray(p1, p2, p3, p4), dist_segment_ray(p1, p2, p4, p3));
}

template<typename T>
T dist_ray_ray(const pt<T>& p1, const pt<T>& p2, const pt<T>& p3, const pt<T>& p4) {
    T dst = min(dist_point_ray(p1, p3, p4), dist_point_ray(p3, p1, p2));
    line l1 = line(p1, p2);
    line l2 = line(p3, p4);
    if (l1.is_parallel_to(l2)) return dst;
    pt i = l1.intersect(l2);
...
template<typename T>
T dist_ray_line(const pt<T>& p1, const pt<T>& p2, const pt<T>& p3, const pt<T>& p4) {
    return min(dist_ray_ray(p1, p2, p3, p4), dist_ray_ray(p1, p2, p4, p3));
}

template<typename T>
T dist_line_line(const pt<T>& p1, const pt<T>& p2, const pt<T>& p3, const pt<T>& p4) {
    line l1 = line(p1, p2);
    line l2 = line(p3, p4);
