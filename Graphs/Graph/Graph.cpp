...
public:
    ...
    void add_edge(int x, Edge e, bool is_directed) {if (V != -1) assert(0 <= x && x < V), assert(0 <= e.to && e.to < V); acc_edge.emplace_back(x, e); if (!is_directed) {swap(x, e.to); acc_edge.emplace_back(x, e);}}
